...
activities = {
    ...
    "Basketball Team": {
        "description": "Join the varsity basketball team and compete in league tournaments",
    ...
    "Debate Club": {
        ...
        "max_participants": 14,
        "participants": ["aidan@mergington.edu"]
    },
    "Science Club": {
        "description": "Conduct experiments, explore STEM topics, and prepare for science fairs",
